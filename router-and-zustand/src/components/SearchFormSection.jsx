...
export function SearchFormSection({hasActiveFilters, initialFilters, onTextFilter, onSearch, onClearFilters, initialText}){
    const idText = useId()
    ...
    return(
        ...
        <form onChange={handleSubmit} id="empleos-search-form" role="search">
            <div className="search-bar">
                ...
                <button type="submit" onClick={handleClearInput}>
